...
export default function Register() {
  ...
  const fields = [
    ...
    { name:'password2', label:'Confirm Password', type:'password', placeholder:'Repeat your password' },
  ]

  return (
    <div style={{ minHeight:'80vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'40px 20px', background:'var(--cream)' }}>
      <div style={{ width:'100%', maxWidth:460, position:'relative', zIndex:1 }} className="animate-fadeup">
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:28, color:'var(--forest)' }}>Join Eco Park</h2>
        </div>
        ...
        <div className="card" style={{ padding:32 }}>
          ...
          <form onSubmit={handleSubmit}>
            {fields.map((f, i) => (
              <div key={f.name} style={{ marginBottom: i < fields.length - 1 ? 18 : 28 }}>
          ...
          <div style={{ textAlign:'center', marginTop:20, paddingTop:20, borderTop:'1px solid var(--sand)' }}>
            <span style={{ fontSize:13, color:'var(--muted)' }}>
              ...
              <Link to="/login" style={{ color:'var(--leaf)', fontWeight:600 }}>Sign in</Link>
            </span>
          </div>
        </div>
      </div>
